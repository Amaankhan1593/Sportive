    ...
    <div>
      ...
      <header className="text-gray-600 body-font sticky top-0 z-50 bg-white shadow-md w-full">
        <div className="container mx-auto flex flex-wrap items-center justify-between px-1 py-7">
          ...
          {/* Icons */}
          <div className="inline-flex space-x-4 lg:justify-end items-center">
            {/* Search */}
            <svg
            ...
            <div className="relative">
              ...
              />
              {cartItems.length > 0 && (
                <span className="absolute -top-2 -right-2 bg-red-600 rounded-full text-xs w-5 h-5 flex items-center justify-center text-white">
...
//   return (
//     <div>
//       {/* Your existing navbar top bar etc. */}
//       <header className="sticky top-0 z-50 bg-white shadow-md w-full p-4 flex justify-between items-center">
//         <Link href="/shop">
...
//             onClick={closeCart}
//           />
//           <div className="fixed top-0 right-0 w-[400px] h-full bg-white shadow-lg p-6 z-50 overflow-y-auto">
//             <div className="flex justify-between items-center mb-4">
//               <h2 className="text-2xl font-bold">Cart</h2>
//               <button onClick={closeCart} className="text-sm px-3 py-1">
//                 Close
//               </button>
//             </div>
//             <hr />
