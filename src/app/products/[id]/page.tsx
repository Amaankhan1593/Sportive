      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-16 lg:py-6 mt-6 lg:mt-0">
                ...
                {["gray"].map((color) => (
                  <button
                    ...
                    className={`border-2 rounded-full w-8 h-8 focus:outline-none ${
                      color === selectedColor ? "border-indigo-600" : "border-gray-300"
                    }`}
                    style={{
                      backgroundColor:
                        color === "gray"
            ...
            <div className="mt-4">
              <div className="text-sm underline text-black mb-2">Sizing guide</div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center border rounded w-25">
                  ...
                  <div className="flex-grow text-center font-semibold text-lg">{quantity}</div>
              ...
              <div className="mt-8 text-gray-700 space-y-3 text-sm">
                ...
                <p className="underline text-black cursor-pointer">View store information</p>

                <hr className="my-1 border-gray-300" />
                <p className="mt-6">
                  Pulling from the Three Stripes design archive, the Men’s adidas Originals
                  Adicolor Colorblock Short-Sleeve T-Shirt features a relaxed fit, bold
                  colorblocking and a partial Trefoil design for a sporty finishing touch.
                </p>

                <p className="mt-4">
                  This is a demo store. You can purchase products like this from Finishline.
                </p>
              </div>
          ...
          <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
              <AccordionTrigger className="ml-140 -mt-5">MATERIALS</AccordionTrigger>
              <AccordionContent className="ml-140">
                Talk about fine lines and great curves. That’s the beauty of the Darcy
                sofa—made to suit your appreciation for clean, contemporary style. A
                striking flared frame, comfy pillow top armrests and an ultra-soft
                upholstery that holds up to everyday living complete this fashion
                statement.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
          ...
          <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
              <AccordionTrigger className="ml-140 -mt-5">SHIPPING & RETURNS</AccordionTrigger>
              <AccordionContent className="ml-140">
                All furniture is thoroughly inspected at several key points in our
                preparation and delivery process to make sure it’s received in good
                condition. If you have chosen to pick up your order from one of our
                showrooms, we encourage you to inspect your item before you take
                possession.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
          ...
          <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
              <AccordionTrigger className="ml-140 -mt-5">CARE GUIDE</AccordionTrigger>
              <AccordionContent className="ml-140">
                Regular care. Use a slightly damp, soft and lint-free cloth for regular
